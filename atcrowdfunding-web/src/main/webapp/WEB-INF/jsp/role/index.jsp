    				...
    				success : function(result) {
    					...
    					if (result.success) {
    						...
    						$.each(roles,function(i, role) {
    							...
    							tableContent += '	<td> ';
    							tableContent += '		<button type="button" onclick="goAssignPage('+ role.id+ ')" class="btn btn-success btn-xs">';
    							tableContent += '			<i class=" glyphicon glyphicon-check"></i> ';
    							tableContent += '		</button> ';
    							tableContent += '		<button type="button" onclick="goUpdatePage('+ role.id+ ')" class="btn btn-primary btn-xs">';
    							tableContent += '			<i class=" glyphicon glyphicon-pencil"></i> ';
    							tableContent += '		</button>                                            ';
    							tableContent += '		<button type="button" onclick="deleteRole('+ role.id+ ',\''+ role.name+ '\')" class="btn btn-danger btn-xs"> ';
